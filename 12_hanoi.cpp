 ...
 * pinos - A (origem), B (destino) e C (auxiliar) - e n discos de diãmetros diferentes.
 ...
 * movido de cada vez, e; (ii) qualquer disco n ̃ao pode ser jamais colocado sobre outro de
 * tamanho menor.
